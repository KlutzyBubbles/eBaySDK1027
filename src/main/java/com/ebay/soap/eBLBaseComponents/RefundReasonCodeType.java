...
public enum RefundReasonCodeType {
    ...
    /**
     * 
     * 						<span class="tablenote"><b>Note: </b> <b>RefundReasonCodeType</b> and all of its values will no longer be applicable once API support for Half.com listings is deprecated.
     * 						</span>
